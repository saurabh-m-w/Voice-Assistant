...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback, MapboxMap.OnMapClickListener, PermissionsListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Mapbox.getInstance(this, "pk.eyJ1Ijoic2F1cmFiaG13IiwiYSI6ImNrOTVjcWg3ZzA0MHQzb3BjdnIwbWtkY2QifQ.58OKaZnhkqp0cp70vKvwSg");
        setContentView(R.layout.activity_map);
        Intent i = getIntent();
        lat = i.getDoubleExtra("lat",MainActivity.latitude2);
        lon = i.getDoubleExtra("lon",MainActivity.longitude2);
